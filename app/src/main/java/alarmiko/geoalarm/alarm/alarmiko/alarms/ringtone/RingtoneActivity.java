...
package alarmiko.geoalarm.alarm.alarmiko.alarms.ringtone;
...
import alarmiko.geoalarm.alarm.alarmiko.BaseActivity;
import alarmiko.geoalarm.alarm.alarmiko.R;
import alarmiko.geoalarm.alarm.alarmiko.alarms.ringtone.playback.RingtoneService;
...
public abstract class RingtoneActivity<T extends Parcelable> extends BaseActivity {
    ...
    public static final String ACTION_FINISH = "ringtone.action.FINISH";
    public static final String EXTRA_RINGING_OBJECT = "ringtone.extra.RINGING_OBJECT";
    public static final String ACTION_SHOW_SILENCED = "ringtone.action.SHOW_SILENCED";
