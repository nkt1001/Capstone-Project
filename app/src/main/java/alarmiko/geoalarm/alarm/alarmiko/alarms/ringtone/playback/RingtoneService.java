...
package alarmiko.geoalarm.alarm.alarmiko.alarms.ringtone.playback;
...
import alarmiko.geoalarm.alarm.alarmiko.alarms.ringtone.RingtoneActivity;
...
public abstract class RingtoneService<T extends Parcelable> extends Service {
    ...
    // public okay
    public static final String ACTION_NOTIFY_MISSED = "ringtone.action.NOTIFY_MISSED";
